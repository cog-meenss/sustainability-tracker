...
*{metadata['generated_at'][:19]} • Advanced Analysis with Visualizations*

[📊 View Interactive Report](../../actions/runs/{os.environ.get('GITHUB_RUN_ID', 'latest')}) • [🌱 Sustainability Guide](../../blob/main/COMPREHENSIVE_SUSTAINABILITY_SUMMARY.md) • [📈 All Analyses](../../actions)
